...
function _load_get_node_handles() {
  return (_get_node_handles = require('../get_node_handles'));
}
  ...
  var _ref3 = _asyncToGenerator(function*(argv, projects) {
    ...
    if (openHandles && openHandles.length) {
      ...
      const message =
        ...
        (0, (_get_node_handles || _load_get_node_handles()).formatHandleErrors)(
          openHandles,
          configs[0]
        ).join('\n\n');
    ...
    const startRun = (() => {
      var _ref12 = _asyncToGenerator(function*() {
        if (!globalConfig.listTests) {
          (0, (_pre_run_message || _load_pre_run_message()).print)(
            outputStream
          );
        }
