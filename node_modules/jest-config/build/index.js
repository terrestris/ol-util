...
function _load_resolve_config_path() {
  return (_resolve_config_path = _interopRequireDefault(
    require('./resolve_config_path')
  ));
}
...
function _load_read_config_file_and_set_root_dir() {
  return (_read_config_file_and_set_root_dir = _interopRequireDefault(
    require('./read_config_file_and_set_root_dir')
  ));
}
...
function readConfig(
  ...
  if (typeof packageRootOrConfig !== 'string') {
    ...
    configPath = (0,
    (_resolve_config_path || _load_resolve_config_path()).default)(
      argv.config,
      process.cwd()
    );
    rawOptions = (0,
    (
      _read_config_file_and_set_root_dir ||
      _load_read_config_file_and_set_root_dir()
    ).default)(configPath);
  } else {
