...
var _get_cache_directory;

function _load_get_cache_directory() {
  return (_get_cache_directory = _interopRequireDefault(
    require('./get_cache_directory')
  ));
}
...
exports.default = {
  ...
  cache: true,
  cacheDirectory: (0,
  (_get_cache_directory || _load_get_cache_directory()).default)(),
