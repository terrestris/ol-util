...
const format = (exports.format = value =>
...
class ValidationError extends Error {
  constructor(name, message, comment) {
    ...
    comment = comment ? '\n\n' + comment : '\n';
    this.name = '';
    this.message = (_chalk || _load_chalk()).default.red(
      (_chalk || _load_chalk()).default.bold(name) + ':\n\n' + message + comment
    );
...
const createDidYouMeanMessage = (exports.createDidYouMeanMessage = (
  ...
  return suggestion
    ? `Did you mean ${(_chalk || _load_chalk()).default.bold(
        format(suggestion)
      )}?`
    : '';
});
